...
//
                                        ArrayList<Map<String, Object>> notesinTask = (ArrayList<Map<String, Object>>) task.get("notes") != null ? (ArrayList<Map<String, Object>>) task.get("notes") : new ArrayList<>();
                                        Log.d("notesInTask", notesinTask+"");
                                        ...
                                        documentReference.update("tasks",tasks)
                                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                    ...
                                                    public void onSuccess(Void unused) {
                                                        Toast.makeText(getContext(), "Note added Successfully", Toast.LENGTH_LONG).show();
